...
- blocked external script, HTML stylesheet, CSS `@import`, image, media, and embedded-document dependencies are surfaced as structured `UNSAFE_NETWORK` evidence instead of being allowed to produce ordinary oracle PASS/FAIL results
