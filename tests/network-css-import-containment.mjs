...
const sink=http.createServer((req,res)=>{
  ...
  res.end('#payload{color:rgb(4, 5, 6)}');
});
...
try {
  ...
  assert.match(summary||'',/UNSAFE_NETWORK · css · external-stylesheet-import/,'blocked preview CSS import must be visible to the user');

  console.log('CSS import-network containment PASS: blocked @import dependencies become deterministic unsafe-network evidence in runner and preview.');
} finally {
