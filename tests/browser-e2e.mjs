...
try{
  ...
  assert.match(connectionText,/eleven WebMCP tools/i);
  ...
  await page.reload({waitUntil:'networkidle'});await page.waitForFunction(()=>window.faultline && window.__webmcpTools?.length===11);
