...
const TOOL_DEFS=[
 ...
 ['faultline_apply_source','Replace one canonical HTML, CSS, or JavaScript source axis using an optimistic revision guard.',{expectedRevision:{type:'string',pattern:'^r[1-9]\\d*$'},targetAxis:{type:'string',enum:['html','css','js']},source:{type:'string'}},async input=>applySource(input),false,['expectedRevision','targetAxis','source']],
